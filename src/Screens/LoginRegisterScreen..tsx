...
const UserAuth = ({ navigation, route }: RootStackScreenProps<"UserLogin">) => {
    ...
    const SubmitRegistrationForm = () => {
        ...
        axios
            .post("http://192.168.1.11:9000/user/registerUser", userSignupForm)
            .then((response) => {
    ...
    const SubmitUserLoginForm = () => {
        axios
            .post("http://192.168.1.11:9000/user/loginUser", userLoginForm)
            .then((response) => {
                console.log(response);
                ...
                navigation.navigate("TabsStack", { screen: "Payment" });
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <KeyboardAvoidingView>
                            ...
                            {!showRegistrationScreen ? (
                                ...
                                >
                                    <Text style={{ textAlign: "center", color: "red", fontSize: 16, fontWeight: "bold", }}>
                                        Login
                                    </Text>
                                </Pressable>
                            ) : (
