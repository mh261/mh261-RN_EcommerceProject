...
export const ProductCard = ({ item, productProps, pStyleProps }: IProductProps) => {
    return (
        <View
            style={sty(pStyleProps?.width, pStyleProps?.marginHorzontal, pStyleProps?.marginBottom).pCardContainer}>
            <ImageBackground
            ...
            {productProps?.percentageWidth !== undefined &&
                <>
                    ...
                    <Text style= {sst(productProps?.percentageWidth ?0:1).progressBar} />
                    </View>
                </>
            }
        </View>
